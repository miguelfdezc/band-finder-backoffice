...
Construye la aplicación para producción en el directorio `build` empaquetando React en modo producción y optimizando su construcción para el mejor rendimiento.
